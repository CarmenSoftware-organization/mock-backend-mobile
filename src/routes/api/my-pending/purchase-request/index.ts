...
export default (app: Elysia) =>
  ...
  // Merged routes from /api/my-pending/purchase-request/:tenant_id/:id
  ...
  // Merged routes from /api/my-pending/purchase-request/:tenant_id/:id/submit
  .patch("/api/my-pending/purchase-request/:tenant_id/:id/submit", ({ params, query, body, headers }) => (null))
  // Merged routes from /api/my-pending/purchase-request/:tenant_id/:id/approve
  .patch("/api/my-pending/purchase-request/:tenant_id/:id/approve", ({ params, query, body, headers }) => (null))
  // Merged routes from /api/my-pending/purchase-request/:tenant_id/:id/reject
  .patch("/api/my-pending/purchase-request/:tenant_id/:id/reject", ({ params, query, body, headers }) => (null))
  // Merged routes from /api/my-pending/purchase-request/:tenant_id/:id/review
  .patch("/api/my-pending/purchase-request/:tenant_id/:id/review", ({ params, query, body, headers }) => (null))
  // Merged routes from /api/my-pending/purchase-request/:tenant_id/:id/save
  .patch("/api/my-pending/purchase-request/:tenant_id/:id/save", ({ params, query, body, headers }) => (null))
