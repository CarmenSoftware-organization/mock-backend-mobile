...
export const purchaseRequestDetails: PurchaseRequestDetail[] = [
  {
    ...
    requested_qty: 5.0,
    requested_unit_id: getUuidByName("UNIT_01"),
  ...
  },
  {
    ...
    exchange_rate_date: null,
    requested_qty: 2.0,
    requested_unit_id: getUuidByName("UNIT_02"),
    requested_unit_name: null,
    requested_unit_conversion_factor: 1,
    requested_base_qty: 1,
    approved_qty: 1,
  ...
  },
  {
    ...
    vendor_id: getUuidByName("VENDOR_01"),
    ...
    requested_qty: 5.0,
    requested_unit_id: getUuidByName("UNIT_03"),
    requested_unit_name: "KG",
    requested_unit_conversion_factor: 1,
    requested_base_qty: 1,
    approved_qty: 10.0,
    approved_unit_id: getUuidByName("UNIT_03"),
    approved_unit_name: "KG",
    approved_unit_conversion_factor: 1000.0,
    approved_base_qty: 10000.0,
    foc_qty: 5.0,
    foc_unit_id: getUuidByName("UNIT_03"),
    foc_unit_name: "GM",
  ...
  },
  {
    ...
    exchange_rate_date: null,
    requested_qty: 5.0,
    requested_unit_id: getUuidByName("UNIT_04"),
    requested_unit_name: "KG",
    requested_unit_conversion_factor: 1,
    requested_base_qty: 1,
    approved_qty: 1,
  ...
  },
  {
    ...
    exchange_rate_date: null,
    requested_qty: 5.0,
    requested_unit_id: getUuidByName("UNIT_05"),
    requested_unit_name: "KG",
    requested_unit_conversion_factor: 1,
    requested_base_qty: 1,
    approved_qty: 1,
  ...
  },
  {
    ...
    product_name: "Chicken Satay",
    product_local_name: null,
    inventory_unit_id: getUuidByName("UNIT_05"),
