...
export const createStockInDetail = (data: Omit<StockInDetail, 'id' | 'created_at' | 'created_by_id' | 'updated_at' | 'updated_by_id'>): StockInDetail => {
...
export const getStockInDetailsByStockInId = (stockInId: string): StockInDetail[] => {
  return stockInDetails.filter(d => d.stock_in_id === stockInId && !d.deleted_at);
};

export const getStockInDetailsByInventoryTransactionId = (inventoryTransactionId: string): StockInDetail[] => {
  return stockInDetails.filter(d => d.inventory_transaction_id === inventoryTransactionId && !d.deleted_at);
};

export const getStockInDetailsByProductId = (productId: string): StockInDetail[] => {
  return stockInDetails.filter(d => d.product_id === productId && !d.deleted_at);
};

export const getStockInDetailsByLocationId = (locationId: string): StockInDetail[] => {
  return stockInDetails.filter(d => d.location_id === locationId && !d.deleted_at);
};

export const getStockInDetailsBySequenceNo = (stockInId: string, sequenceNo: number): StockInDetail | null => {
  const detail = stockInDetails.find(d => 
...
export const updateStockInDetail = (id: string, data: Partial<Omit<StockInDetail, 'id' | 'created_at' | 'created_by_id'>>): StockInDetail | null => {
...
export const updateStockInDetailDescription = (id: string, description: string): StockInDetail | null => {
  return updateStockInDetail(id, { description });
};

// UPDATE - อัปเดต StockInDetail qty
export const updateStockInDetailQty = (id: string, qty: string): StockInDetail | null => {
  return updateStockInDetail(id, { qty });
};

// UPDATE - อัปเดต StockInDetail note
export const updateStockInDetailNote = (id: string, note: string): StockInDetail | null => {
  return updateStockInDetail(id, { note });
};

// UPDATE - อัปเดต StockInDetail info
export const updateStockInDetailInfo = (id: string, info: any): StockInDetail | null => {
  return updateStockInDetail(id, { info });
};

// UPDATE - อัปเดต StockInDetail dimension
export const updateStockInDetailDimension = (id: string, dimension: any): StockInDetail | null => {
  return updateStockInDetail(id, { dimension });
};

// UPDATE - อัปเดต StockInDetail location
export const updateStockInDetailLocation = (id: string, locationId: string, locationName: string): StockInDetail | null => {
...
export const updateStockInDetailProduct = (id: string, productId: string, productName: string, productLocalName: string): StockInDetail | null => {
  return updateStockInDetail(id, { 
...
export const softDeleteStockInDetail = (id: string, deletedById: string): StockInDetail | null => {
...
export const deleteStockInDetailsByStockInId = (stockInId: string, deletedById: string): number => {
  let deletedCount = 0;
...
export const searchStockInDetails = (criteria: {
  ...
  return stockInDetails.filter(detail => {
    ...
    if (criteria.stockInId && detail.stock_in_id !== criteria.stockInId) return false;
...
export const getStockInDetailCountByStockInId = (stockInId: string): number => {
  return stockInDetails.filter(detail => detail.stock_in_id === stockInId && !detail.deleted_at).length;
};

export const isStockInDetailExists = (id: string): boolean => {
  return stockInDetails.some(detail => detail.id === id && !detail.deleted_at);
};

export const isSequenceNoExists = (stockInId: string, sequenceNo: number): boolean => {
  return stockInDetails.some(detail => 
