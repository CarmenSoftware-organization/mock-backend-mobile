...
export const createRequestForPricingDetail = (data: Omit<RequestForPricingDetail, 'id' | 'created_at' | 'created_by_id'>): RequestForPricingDetail => {
...
export const getRequestForPricingDetailById = (id: string): RequestForPricingDetail | null => {
  const detail = requestForPricingDetails.find(detail => detail.id === id && !detail.deleted_at);
  return detail || null;
};

// READ - อ่าน RequestForPricingDetail ตาม request_for_pricing_id
export const getRequestForPricingDetailsByRequestId = (requestId: string): RequestForPricingDetail[] => {
  return requestForPricingDetails.filter(detail => detail.request_for_pricing_id === requestId && !detail.deleted_at);
};

// READ - อ่าน RequestForPricingDetail ตาม sequence_no
export const getRequestForPricingDetailsBySequenceNo = (sequenceNo: number): RequestForPricingDetail[] => {
  return requestForPricingDetails.filter(detail => detail.sequence_no === sequenceNo && !detail.deleted_at);
};

// READ - อ่าน RequestForPricingDetail ตาม vendor_id
export const getRequestForPricingDetailsByVendorId = (vendorId: string): RequestForPricingDetail[] => {
  return requestForPricingDetails.filter(detail => detail.vendor_id === vendorId && !detail.deleted_at);
};

// READ - อ่าน RequestForPricingDetail ตาม pricelist_id
export const getRequestForPricingDetailsByPricelistId = (pricelistId: string): RequestForPricingDetail[] => {
  return requestForPricingDetails.filter(detail => detail.pricelist_id === pricelistId && !detail.deleted_at);
};

// READ - อ่าน RequestForPricingDetail ที่มี info
export const getRequestForPricingDetailsWithInfo = (): RequestForPricingDetail[] => {
  return requestForPricingDetails.filter(detail => detail.info && !detail.deleted_at);
};

// READ - อ่าน RequestForPricingDetail ที่มี dimension
export const getRequestForPricingDetailsWithDimension = (): RequestForPricingDetail[] => {
  return requestForPricingDetails.filter(detail => detail.dimension && !detail.deleted_at);
};

// READ - ค้นหา RequestForPricingDetail แบบ fuzzy search
export const searchRequestForPricingDetails = (searchTerm: string): RequestForPricingDetail[] => {
  const lowerSearchTerm = searchTerm.toLowerCase();
  
  return requestForPricingDetails.filter(detail => 
    !detail.deleted_at && (
      ...
      detail.dimension?.cost_center?.toLowerCase().includes(lowerSearchTerm) ||
...
export const updateRequestForPricingDetail = (id: string, updates: Partial<Omit<RequestForPricingDetail, 'id' | 'created_at' | 'created_by_id'>>): RequestForPricingDetail | null => {
  const index = requestForPricingDetails.findIndex(detail => detail.id === id);
...
export const updateRequestForPricingDetailSequenceNo = (id: string, sequenceNo: number): RequestForPricingDetail | null => {
  return updateRequestForPricingDetail(id, { sequence_no: sequenceNo });
};

// UPDATE - อัปเดต RequestForPricingDetail vendor info
export const updateRequestForPricingDetailVendorInfo = (id: string, vendorId: string, vendorName: string): RequestForPricingDetail | null => {
...
export const updateRequestForPricingDetailContactInfo = (id: string, contactPerson: string, contactPhone: string, contactEmail: string): RequestForPricingDetail | null => {
  return updateRequestForPricingDetail(id, { 
...
export const updateRequestForPricingDetailPricelistInfo = (id: string, pricelistId: string, pricelistName: string): RequestForPricingDetail | null => {
  return updateRequestForPricingDetail(id, { 
...
export const updateRequestForPricingDetailInfo = (id: string, info: any): RequestForPricingDetail | null => {
  return updateRequestForPricingDetail(id, { info });
};

// UPDATE - อัปเดต RequestForPricingDetail dimension
export const updateRequestForPricingDetailDimension = (id: string, dimension: any): RequestForPricingDetail | null => {
  return updateRequestForPricingDetail(id, { dimension });
};

// UPDATE - อัปเดต RequestForPricingDetail doc_version
export const updateRequestForPricingDetailDocVersion = (id: string, docVersion: string): RequestForPricingDetail | null => {
  return updateRequestForPricingDetail(id, { doc_version: docVersion });
};

// DELETE - ลบ RequestForPricingDetail (soft delete)
export const deleteRequestForPricingDetail = (id: string, deletedById: string): boolean => {
  const index = requestForPricingDetails.findIndex(detail => detail.id === id);
...
export const deleteRequestForPricingDetailsByRequestId = (requestId: string, deletedById: string): number => {
  let deletedCount = 0;
...
export const deleteRequestForPricingDetailsByVendorId = (vendorId: string, deletedById: string): number => {
  let deletedCount = 0;
...
export const deleteRequestForPricingDetailsByPricelistId = (pricelistId: string, deletedById: string): number => {
  let deletedCount = 0;
...
export const restoreRequestForPricingDetailsByRequestId = (requestId: string): number => {
  let restoredCount = 0;
...
export const restoreRequestForPricingDetailsByVendorId = (vendorId: string): number => {
  let restoredCount = 0;
...
export const restoreRequestForPricingDetailsByPricelistId = (pricelistId: string): number => {
  let restoredCount = 0;
...
export const getRequestForPricingDetailCountByRequestId = (requestId: string): number => {
  return requestForPricingDetails.filter(detail => detail.request_for_pricing_id === requestId).length;
};

// Utility function สำหรับนับจำนวน RequestForPricingDetail ตาม vendor_id
export const getRequestForPricingDetailCountByVendorId = (vendorId: string): number => {
  return requestForPricingDetails.filter(detail => detail.vendor_id === vendorId).length;
};

// Utility function สำหรับนับจำนวน RequestForPricingDetail ตาม pricelist_id
export const getRequestForPricingDetailCountByPricelistId = (pricelistId: string): number => {
  return requestForPricingDetails.filter(detail => detail.pricelist_id === pricelistId).length;
};

// Utility function สำหรับตรวจสอบ RequestForPricingDetail ที่ถูกลบแล้ว
export const getDeletedRequestForPricingDetails = (): RequestForPricingDetail[] => {
  return requestForPricingDetails.filter(detail => detail.deleted_at !== null);
};
