...
export const createInventoryTransactionClosingBalance = (
  closingBalanceData: Omit<
...
export const getAllInventoryTransactionClosingBalances =
  (): InventoryTransactionClosingBalance[] => {
    return [...inventoryTransactionClosingBalances];
  };

// READ - อ่าน InventoryTransactionClosingBalance ตาม ID
export const getInventoryTransactionClosingBalanceById = (
  id: string
): InventoryTransactionClosingBalance | undefined => {
  return inventoryTransactionClosingBalances.find(
    (balance) => balance.id === id
  );
};

// READ - อ่าน InventoryTransactionClosingBalance ตาม inventory_transaction_detail_id
export const getInventoryTransactionClosingBalancesByTransactionDetailId = (
  transactionDetailId: string
): InventoryTransactionClosingBalance[] => {
  return inventoryTransactionClosingBalances.filter(
    (balance) => balance.inventory_transaction_detail_id === transactionDetailId
  );
};

// READ - อ่าน InventoryTransactionClosingBalance ตาม lot_no
export const getInventoryTransactionClosingBalancesByLotNo = (
  lotNo: string
): InventoryTransactionClosingBalance[] => {
  return inventoryTransactionClosingBalances.filter(
    (balance) => balance.lot_no === lotNo
  );
};

// READ - อ่าน InventoryTransactionClosingBalance ตาม lot_index
export const getInventoryTransactionClosingBalancesByLotIndex = (
  lotIndex: number
): InventoryTransactionClosingBalance[] => {
  return inventoryTransactionClosingBalances.filter(
    (balance) => balance.lot_index === lotIndex
  );
};

// READ - อ่าน InventoryTransactionClosingBalance ตาม location_id
export const getInventoryTransactionClosingBalancesByLocationId = (
  locationId: string
): InventoryTransactionClosingBalance[] => {
  return inventoryTransactionClosingBalances.filter(
    (balance) => balance.location_id === locationId
  );
};

// READ - อ่าน InventoryTransactionClosingBalance ตาม product_id
export const getInventoryTransactionClosingBalancesByProductId = (
  productId: string
): InventoryTransactionClosingBalance[] => {
  return inventoryTransactionClosingBalances.filter(
...
export const getActiveInventoryTransactionClosingBalances =
  (): InventoryTransactionClosingBalance[] => {
    return inventoryTransactionClosingBalances.filter(
      (balance) => balance.deleted_at === null
    );
  };

// READ - อ่าน InventoryTransactionClosingBalance ที่ถูกลบแล้ว
export const getDeletedInventoryTransactionClosingBalances =
  (): InventoryTransactionClosingBalance[] => {
    return inventoryTransactionClosingBalances.filter(
      (balance) => balance.deleted_at !== null
    );
...
export const getInventoryTransactionClosingBalancesByCreatedBy = (
  createdById: string
): InventoryTransactionClosingBalance[] => {
  return inventoryTransactionClosingBalances.filter(
    (balance) => balance.created_by_id === createdById
  );
};

// READ - อ่าน InventoryTransactionClosingBalance ตาม updated_by_id
export const getInventoryTransactionClosingBalancesByUpdatedBy = (
  updatedById: string
): InventoryTransactionClosingBalance[] => {
  return inventoryTransactionClosingBalances.filter(
    (balance) => balance.updated_by_id === updatedById
  );
};

// READ - อ่าน InventoryTransactionClosingBalance ที่มี note
export const getInventoryTransactionClosingBalancesWithNote =
  (): InventoryTransactionClosingBalance[] => {
    return inventoryTransactionClosingBalances.filter(
      (balance) => balance.note && balance.note.trim() !== ""
    );
  };

// READ - อ่าน InventoryTransactionClosingBalance ที่มี info
export const getInventoryTransactionClosingBalancesWithInfo =
  (): InventoryTransactionClosingBalance[] => {
    return inventoryTransactionClosingBalances.filter(
      (balance) => balance.info !== null
    );
  };

// READ - อ่าน InventoryTransactionClosingBalance ที่มี dimension
export const getInventoryTransactionClosingBalancesWithDimension =
  (): InventoryTransactionClosingBalance[] => {
    return inventoryTransactionClosingBalances.filter(
      (balance) => balance.dimension !== null
    );
  };

// READ - อ่าน InventoryTransactionClosingBalance ตาม cost_per_unit range
export const getInventoryTransactionClosingBalancesByCostRange = (
  minCost: number,
  maxCost: number
): InventoryTransactionClosingBalance[] => {
...
export const getInventoryTransactionClosingBalancesByTotalCostRange = (
  minTotalCost: number,
  maxTotalCost: number
): InventoryTransactionClosingBalance[] => {
  return inventoryTransactionClosingBalances.filter((balance) => {
...
export const getInventoryTransactionClosingBalancesByInQtyRange = (
  minInQty: number,
  maxInQty: number
): InventoryTransactionClosingBalance[] => {
  return inventoryTransactionClosingBalances.filter((balance) => {
...
export const getInventoryTransactionClosingBalancesByOutQtyRange = (
  minOutQty: number,
  maxOutQty: number
): InventoryTransactionClosingBalance[] => {
  return inventoryTransactionClosingBalances.filter((balance) => {
...
export const searchInventoryTransactionClosingBalancesFuzzy = (
  searchTerm: string
): InventoryTransactionClosingBalance[] => {
...
export const updateInventoryTransactionClosingBalance = (
  id: string,
  updateData: Partial<
    Omit<
      InventoryTransactionClosingBalance,
    ...
    >
  >
): InventoryTransactionClosingBalance | null => {
  const index = inventoryTransactionClosingBalances.findIndex(
    (balance) => balance.id === id
  );
...
export const updateInventoryTransactionClosingBalanceLotNo = (
  id: string,
  lotNo: string
): InventoryTransactionClosingBalance | null => {
...
export const updateInventoryTransactionClosingBalanceLotIndex = (
  id: string,
  lotIndex: number
): InventoryTransactionClosingBalance | null => {
...
export const updateInventoryTransactionClosingBalanceInQty = (
  id: string,
  inQty: string
): InventoryTransactionClosingBalance | null => {
...
export const updateInventoryTransactionClosingBalanceOutQty = (
  id: string,
  outQty: string
): InventoryTransactionClosingBalance | null => {
...
export const updateInventoryTransactionClosingBalanceCostPerUnit = (
  id: string,
  costPerUnit: string
): InventoryTransactionClosingBalance | null => {
  return updateInventoryTransactionClosingBalance(id, {
    cost_per_unit: costPerUnit,
  });
};

// UPDATE - อัปเดต InventoryTransactionClosingBalance total_cost
export const updateInventoryTransactionClosingBalanceTotalCost = (
  id: string,
  totalCost: string
): InventoryTransactionClosingBalance | null => {
  return updateInventoryTransactionClosingBalance(id, {
...
export const updateInventoryTransactionClosingBalanceNote = (
  id: string,
  note: string
): InventoryTransactionClosingBalance | null => {
...
export const updateInventoryTransactionClosingBalanceInfo = (
  id: string,
  info: any
): InventoryTransactionClosingBalance | null => {
...
export const updateInventoryTransactionClosingBalanceDimension = (
  id: string,
  dimension: any
): InventoryTransactionClosingBalance | null => {
...
export const updateInventoryTransactionClosingBalanceByLotAndIndex = (
  lotNo: string,
  lotIndex: number,
  updateData: Partial<
    Omit<
  ...
  const index = inventoryTransactionClosingBalances.findIndex(
    (balance) => balance.lot_no === lotNo && balance.lot_index === lotIndex
  );
...
export const deleteInventoryTransactionClosingBalance = (
  id: string,
  deletedById: string
): boolean => {
  const index = inventoryTransactionClosingBalances.findIndex(
...
export const hardDeleteInventoryTransactionClosingBalance = (
  id: string
): boolean => {
  const index = inventoryTransactionClosingBalances.findIndex(
    (balance) => balance.id === id
...
export const deleteInventoryTransactionClosingBalancesByTransactionDetailId = (
  transactionDetailId: string,
  deletedById: string
): number => {
  let deletedCount = 0;
  ...
  inventoryTransactionClosingBalances.forEach((balance) => {
    if (
      balance.inventory_transaction_detail_id === transactionDetailId &&
      !balance.deleted_at
    ) {
...
export const deleteInventoryTransactionClosingBalancesByLotNo = (
  lotNo: string,
  deletedById: string
): number => {
  let deletedCount = 0;
...
export const deleteInventoryTransactionClosingBalancesByLocationId = (
  locationId: string,
  deletedById: string
): number => {
  let deletedCount = 0;
...
export const deleteInventoryTransactionClosingBalancesByProductId = (
  productId: string,
  deletedById: string
): number => {
  let deletedCount = 0;
...
export const deleteInventoryTransactionClosingBalanceByLotAndIndex = (
  lotNo: string,
  lotIndex: number,
  deletedById: string
): boolean => {
...
export const restoreInventoryTransactionClosingBalance = (
  id: string
): boolean => {
  const index = inventoryTransactionClosingBalances.findIndex(
    (balance) => balance.id === id
...
export const restoreInventoryTransactionClosingBalancesByTransactionDetailId = (
  transactionDetailId: string
): number => {
  let restoredCount = 0;
...
export const restoreInventoryTransactionClosingBalancesByLotNo = (
  lotNo: string
): number => {
  let restoredCount = 0;
...
export const restoreInventoryTransactionClosingBalancesByLocationId = (
  locationId: string
): number => {
  let restoredCount = 0;
...
export const restoreInventoryTransactionClosingBalancesByProductId = (
  productId: string
): number => {
  let restoredCount = 0;
...
export const getInventoryTransactionClosingBalanceCountByTransactionDetailId = (
  transactionDetailId: string
): number => {
  return inventoryTransactionClosingBalances.filter(
    (balance) => balance.inventory_transaction_detail_id === transactionDetailId
...
export const getInventoryTransactionClosingBalanceCountByLotNo = (
  lotNo: string
): number => {
  return inventoryTransactionClosingBalances.filter(
    (balance) => balance.lot_no === lotNo
...
export const getInventoryTransactionClosingBalanceCountByLocationId = (
  locationId: string
): number => {
  return inventoryTransactionClosingBalances.filter(
    (balance) => balance.location_id === locationId
...
export const getInventoryTransactionClosingBalanceCountByProductId = (
  productId: string
): number => {
  return inventoryTransactionClosingBalances.filter(
    (balance) => balance.product_id === productId
...
export const getInventoryTransactionClosingBalanceCountByCreatedBy = (
  createdById: string
): number => {
  return inventoryTransactionClosingBalances.filter(
    (balance) => balance.created_by_id === createdById
...
export const getInventoryTransactionClosingBalanceCountByUpdatedBy = (
  updatedById: string
): number => {
  return inventoryTransactionClosingBalances.filter(
    (balance) => balance.updated_by_id === updatedById
...
export const searchInventoryTransactionClosingBalances = (searchCriteria: {
  ...
  return inventoryTransactionClosingBalances.filter((balance) => {
    if (
      searchCriteria.inventory_transaction_detail_id &&
      balance.inventory_transaction_detail_id !==
        searchCriteria.inventory_transaction_detail_id
    ) {
      return false;
    }
    ...
    if (
      searchCriteria.lot_index !== undefined &&
      balance.lot_index !== searchCriteria.lot_index
    ) {
      return false;
    }
    ...
    if (
      ...
      balance.location_id !== searchCriteria.location_id
    ) {
      return false;
    }
    ...
    if (
      ...
      balance.product_id !== searchCriteria.product_id
    ) {
      return false;
    }
    ...
    if (
      ...
      balance.created_by_id !== searchCriteria.created_by_id
    ) {
      return false;
    }
    ...
    if (
      ...
      balance.updated_by_id !== searchCriteria.updated_by_id
    ) {
      return false;
    }
...
export const isInventoryTransactionClosingBalanceExistsByTransactionDetailId = (
  transactionDetailId: string
): boolean => {
  return inventoryTransactionClosingBalances.some(
    (balance) => balance.inventory_transaction_detail_id === transactionDetailId
  );
};

// Utility function สำหรับตรวจสอบ InventoryTransactionClosingBalance ตาม lot_no
export const isInventoryTransactionClosingBalanceExistsByLotNo = (
  lotNo: string
): boolean => {
  return inventoryTransactionClosingBalances.some(
    (balance) => balance.lot_no === lotNo
...
export const isInventoryTransactionClosingBalanceExistsByLotAndIndex = (
  lotNo: string,
  lotIndex: number
): boolean => {
  return inventoryTransactionClosingBalances.some(
...
export const hasInventoryTransactionClosingBalancesWithDimension =
  (): boolean => {
    return inventoryTransactionClosingBalances.some(
      (balance) => balance.dimension !== null
    );
...
export const addMultipleInventoryTransactionClosingBalances = (
  closingBalancesData: Omit<
    InventoryTransactionClosingBalance,
    "id" | "created_at" | "updated_at"
  >[]
): InventoryTransactionClosingBalance[] => {
...
export const removeMultipleInventoryTransactionClosingBalancesByTransactionDetailId =
  (transactionDetailId: string, deletedById: string): number => {
    return deleteInventoryTransactionClosingBalancesByTransactionDetailId(
      transactionDetailId,
      deletedById
    );
  };
...
export const removeMultipleInventoryTransactionClosingBalancesByLotNo = (
  lotNo: string,
  deletedById: string
): number => {
...
export const removeMultipleInventoryTransactionClosingBalancesByLocationId = (
  locationId: string,
  deletedById: string
): number => {
  return deleteInventoryTransactionClosingBalancesByLocationId(
    locationId,
    deletedById
  );
};
...
export const removeMultipleInventoryTransactionClosingBalancesByProductId = (
  productId: string,
  deletedById: string
): number => {
  return deleteInventoryTransactionClosingBalancesByProductId(
    productId,
    deletedById
  );
};
...
export const hardDeleteInventoryTransactionClosingBalancesByTransactionDetailId =
  (transactionDetailId: string): number => {
    let deletedCount = 0;

    for (let i = inventoryTransactionClosingBalances.length - 1; i >= 0; i--) {
      if (
        inventoryTransactionClosingBalances[i]
          .inventory_transaction_detail_id === transactionDetailId
      ) {
...
export const hardDeleteInventoryTransactionClosingBalancesByLotNo = (
  lotNo: string
): number => {
  let deletedCount = 0;
...
export const hardDeleteInventoryTransactionClosingBalancesByLocationId = (
  locationId: string
): number => {
  let deletedCount = 0;
...
export const hardDeleteInventoryTransactionClosingBalancesByProductId = (
  productId: string
): number => {
  let deletedCount = 0;
...
export const getNextLotIndex = (lotNo: string): number => {
  const existingBalances = inventoryTransactionClosingBalances.filter(
    (balance) => balance.lot_no === lotNo
  );
  ...
  const maxLotIndex = Math.max(
    ...existingBalances.map((balance) => balance.lot_index)
  );
...
export const calculateRemainingQty = (
  inQty: string,
  outQty: string
): string => {
  const inQtyNum = parseFloat(inQty);
