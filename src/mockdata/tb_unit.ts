...
export const units: Unit[] = [
  ...
  {
    id: getUuidByName("UNIT_11"),
    name: "PCS",
    description: "Pieces - Individual countable items",
    is_active: true,
    note: "Used for countable individual items like electronics, books, etc.",
    info: { type: "count", singular: "piece", plural: "pieces" },
    dimension: null,
  ...
  {
    id: getUuidByName("UNIT_12"),
    name: "LTR",
    description: "Liters - Volume measurement for liquids",
    is_active: true,
    note: "Used for liquid products like beverages, oils, chemicals",
    info: { type: "volume", base_unit: "liter", metric: true },
    dimension: null,
  ...
  {
    id: getUuidByName("UNIT_13"),
    name: "PACK",
    description: "Package - Pre-packaged items sold as units",
    is_active: true,
    note: "Used for packaged items like paper, pens, vitamins",
    info: { type: "packaging", contains_multiple: true },
    dimension: null,
    created_at: "2025-01-15T08:10:00.000Z",
    created_by_id: getUuidByName("USER_ADMIN"),
    updated_at: "2025-01-15T08:10:00.000Z",
    updated_by_id: null,
    deleted_at: null,
    deleted_by_id: null,
  },
  {
    id: getUuidByName("UNIT_14"),
    name: "PAIR",
    description: "Pair - Items sold in pairs",
    is_active: true,
    note: "Used for items naturally sold in pairs like shoes, gloves",
    info: { type: "count", quantity_per_unit: 2 },
    dimension: null,
    created_at: "2025-01-15T08:15:00.000Z",
    created_by_id: getUuidByName("USER_ADMIN"),
  ...
  {
    id: getUuidByName("UNIT_15"),
    name: "SET",
    description: "Set - Collection of related items sold together",
    is_active: true,
    note: "Used for tool sets, equipment sets, furniture sets",
    info: { type: "collection", contains_multiple_types: true },
    dimension: null,
    created_at: "2025-01-15T08:20:00.000Z",
    created_by_id: getUuidByName("USER_ADMIN"),
    updated_at: "2025-01-15T08:20:00.000Z",
    updated_by_id: null,
    deleted_at: null,
    deleted_by_id: null,
  },
