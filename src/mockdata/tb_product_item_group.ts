...
export const productItemGroups: ProductItemGroup[] = [
  {
    id: getUuidByName("PRODUCT_ITEM_GROUP_01"),
    product_subcategory_id: getUuidByName("PRODUCT_SUB_CATEGORY_01"),
    code: "LAPTOP",
    name: "Laptops",
  ...
  {
    id: getUuidByName("PRODUCT_ITEM_GROUP_02"),
    product_subcategory_id: getUuidByName("PRODUCT_SUB_CATEGORY_01"),
    code: "SMART",
    name: "Smartphones",
  ...
  {
    id: getUuidByName("PRODUCT_ITEM_GROUP_03"),
    product_subcategory_id: getUuidByName("PRODUCT_SUB_CATEGORY_02"),
    code: "TSHIRT",
    name: "T-Shirts",
  ...
  {
    id: getUuidByName("PRODUCT_ITEM_GROUP_04"),
  ...
  {
    id: getUuidByName("PRODUCT_ITEM_GROUP_05"),
    product_subcategory_id: getUuidByName("PRODUCT_SUB_CATEGORY_02"),
    code: "ACC",
    name: "Accessories",
