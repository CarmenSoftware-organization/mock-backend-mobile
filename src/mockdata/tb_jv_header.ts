...
export const jvHeaders: JvHeader[] = [
  {
    ...
    workflow_history: [
      { stage: "Draft", action: "Created", date: "2024-01-15T10:00:00Z", user: "fe007ceb-9320-41ed-92ac-d6ea1f66b3c1" },
      { stage: "Review", action: "Submitted", date: "2024-01-15T10:15:00Z", user: "fe007ceb-9320-41ed-92ac-d6ea1f66b3c1" },
      { stage: "Approval", action: "Approved", date: "2024-01-15T10:25:00Z", user: "3c5280a7-492e-421d-b739-7447455ce99e" }
    ],
    workflow_current_stage: "Completed",
    workflow_previous_stage: "Approval",
    workflow_next_stage: "Completed",
    user_action: { current_user: "fe007ceb-9320-41ed-92ac-d6ea1f66b3c1", available_actions: ["view"] },
    ...
    info: { total_debit: 100000.00, total_credit: 100000.00, posted_date: "2024-01-15" },
  ...
  },
  {
    ...
    workflow_name: "JV Approval Workflow",
    workflow_history: [
      { stage: "Draft", action: "Created", date: "2024-01-16T09:00:00Z", user: "1bfdb891-58ee-499c-8115-34a964de8122" }
    ],
    workflow_current_stage: "Draft",
    workflow_previous_stage: "Draft",
    workflow_next_stage: "Review",
    user_action: { current_user: "1bfdb891-58ee-499c-8115-34a964de8122", available_actions: ["edit", "submit", "delete"] },
    last_action: "submit",
    ...
    info: { total_debit: 75000.00, total_credit: 75000.00, posted_date: null },
    dimension: { department: "Finance", region: "All" },
    doc_version: "1.0",
    created_at: "2024-01-15T10:30:00Z",
  ...
  },
  {
    ...
    workflow_name: "JV Approval Workflow",
    workflow_history: [
      { stage: "Draft", action: "Created", date: "2024-01-17T08:00:00Z", user: "3c5280a7-492e-421d-b739-7447455ce99e" },
      { stage: "Review", action: "Submitted", date: "2024-01-17T08:15:00Z", user: "3c5280a7-492e-421d-b739-7447455ce99e" },
      { stage: "Approval", action: "Approved", date: "2024-01-17T08:25:00Z", user: "fe007ceb-9320-41ed-92ac-d6ea1f66b3c1" }
    ],
    workflow_current_stage: "Completed",
    workflow_previous_stage: "Approval",
    workflow_next_stage: "Completed",
    user_action: { current_user: "3c5280a7-492e-421d-b739-7447455ce99e", available_actions: ["view"] },
    last_action: "complete",
    ...
    info: { total_debit: 25000.00, total_credit: 25000.00, posted_date: "2024-01-17" },
    dimension: { department: "Finance", region: "All" },
    doc_version: "1.0",
    created_at: "2024-01-15T10:30:00Z",
...
export const createJvHeader = (jvHeaderData: Omit<JvHeader, 'id' | 'created_at' | 'updated_at'>): JvHeader => {
...
export const getJvHeadersByStatus = (status: 'draft' | 'posted' | 'cancelled'): JvHeader[] => {
...
export const getJvHeadersByDateRange = (startDate: string, endDate: string): JvHeader[] => {
  return jvHeaders.filter(jv => 
    jv.jv_date >= startDate && jv.jv_date <= endDate
  );
};
...
export const getJvHeadersByAmountRange = (minAmount: number, maxAmount: number): JvHeader[] => {
  return jvHeaders.filter(jv => {
...
export const updateJvHeader = (id: string, updateData: Partial<Omit<JvHeader, 'id' | 'created_at' | 'created_by_id'>>): JvHeader | null => {
...
export const updateJvHeaderStatus = (id: string, status: 'draft' | 'posted' | 'cancelled'): JvHeader | null => {
  return updateJvHeader(id, { jv_status: status });
};

// UPDATE - อัปเดต JvHeader JV date
export const updateJvHeaderDate = (id: string, jvDate: string): JvHeader | null => {
  return updateJvHeader(id, { jv_date: jvDate });
};

// UPDATE - อัปเดต JvHeader description
export const updateJvHeaderDescription = (id: string, description: string): JvHeader | null => {
  return updateJvHeader(id, { description });
};

// UPDATE - อัปเดต JvHeader totals
export const updateJvHeaderTotals = (id: string, totalDebit: number, totalCredit: number): JvHeader | null => {
...
export const updateJvHeaderNote = (id: string, note: string): JvHeader | null => {
  return updateJvHeader(id, { note });
};

// UPDATE - อัปเดต JvHeader currency
export const updateJvHeaderCurrency = (id: string, currencyId: string): JvHeader | null => {
  return updateJvHeader(id, { currency_id: currencyId });
};

// UPDATE - Post JvHeader
export const postJvHeader = (id: string, postedById: string): JvHeader | null => {
...
export const deleteJvHeaderByNumber = (jvNumber: string, deletedById: string): boolean => {
...
export const deleteJvHeadersByStatus = (status: 'draft' | 'posted' | 'cancelled', deletedById: string): number => {
  let deletedCount = 0;
...
export const deleteJvHeadersByCurrency = (currencyId: string, deletedById: string): number => {
  let deletedCount = 0;
...
export const getJvHeaderCountByStatus = (status: 'draft' | 'posted' | 'cancelled'): number => {
...
export const searchJvHeadersAdvanced = (searchCriteria: {
  ...
  return jvHeaders.filter(jv => {
    if (searchCriteria.jv_no && !jv.jv_no.toLowerCase().includes(searchCriteria.jv_no.toLowerCase())) {
      return false;
    }
    ...
    if (searchCriteria.currency_id && jv.currency_id !== searchCriteria.currency_id) {
      return false;
    }
    
    if (searchCriteria.min_amount && (jv.info?.total_debit || 0) < searchCriteria.min_amount) {
      return false;
    }
    
    if (searchCriteria.max_amount && (jv.info?.total_debit || 0) > searchCriteria.max_amount) {
      return false;
    }
