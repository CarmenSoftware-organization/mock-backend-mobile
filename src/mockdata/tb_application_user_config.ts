...
export const getApplicationUserConfigByUserIdAndKey = (
  ...
  return applicationUserConfigs.find(
    (config) => config.user_id === userId && config.key === key
  );
};
...
export const getApplicationUserConfigsByCreatedBy = (
  ...
  return applicationUserConfigs.filter(
...
export const getApplicationUserConfigCountByUserId = (
  ...
  return applicationUserConfigs.filter(
    (config) => config.user_id === userId && !config.deleted_at
  ).length;
};
...
export const isApplicationUserConfigKeyExistsForUser = (
  ...
  return applicationUserConfigs.some(
    (config) =>
