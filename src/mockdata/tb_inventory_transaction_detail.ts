...
export const createInventoryTransactionDetail = (
  transactionDetailData: Omit<
...
export const getAllInventoryTransactionDetails =
  (): InventoryTransactionDetail[] => {
    return [...inventoryTransactionDetails];
  };

// READ - อ่าน InventoryTransactionDetail ตาม ID
export const getInventoryTransactionDetailById = (
  id: string
): InventoryTransactionDetail | undefined => {
...
export const getInventoryTransactionDetailsByTransactionId = (
  transactionId: string
): InventoryTransactionDetail[] => {
  return inventoryTransactionDetails.filter(
    (detail) => detail.inventory_transaction_id === transactionId
  );
};

// READ - อ่าน InventoryTransactionDetail ตาม from_lot_no
export const getInventoryTransactionDetailsByFromLotNo = (
  fromLotNo: string
): InventoryTransactionDetail[] => {
  return inventoryTransactionDetails.filter(
    (detail) => detail.from_lot_no === fromLotNo
  );
};

// READ - อ่าน InventoryTransactionDetail ตาม current_lot_no
export const getInventoryTransactionDetailsByCurrentLotNo = (
  currentLotNo: string
): InventoryTransactionDetail[] => {
  return inventoryTransactionDetails.filter(
    (detail) => detail.current_lot_no === currentLotNo
  );
};

// READ - อ่าน InventoryTransactionDetail ตาม location_id
export const getInventoryTransactionDetailsByLocationId = (
  locationId: string
): InventoryTransactionDetail[] => {
  return inventoryTransactionDetails.filter(
...
export const getInventoryTransactionDetailsByProductId = (
  productId: string
): InventoryTransactionDetail[] => {
  return inventoryTransactionDetails.filter(
...
export const getActiveInventoryTransactionDetails =
  (): InventoryTransactionDetail[] => {
    return inventoryTransactionDetails.filter(
...
export const getDeletedInventoryTransactionDetails =
  (): InventoryTransactionDetail[] => {
    return inventoryTransactionDetails.filter(
      (detail) => detail.deleted_at !== null
    );
...
export const getInventoryTransactionDetailsByCreatedBy = (
  createdById: string
): InventoryTransactionDetail[] => {
  return inventoryTransactionDetails.filter(
...
export const getInventoryTransactionDetailsByUpdatedBy = (
  updatedById: string
): InventoryTransactionDetail[] => {
  return inventoryTransactionDetails.filter(
...
export const getInventoryTransactionDetailsWithNote =
  (): InventoryTransactionDetail[] => {
    return inventoryTransactionDetails.filter(
...
export const getInventoryTransactionDetailsWithInfo =
  (): InventoryTransactionDetail[] => {
    return inventoryTransactionDetails.filter((detail) => detail.info !== null);
  };

// READ - อ่าน InventoryTransactionDetail ที่มี dimension
export const getInventoryTransactionDetailsWithDimension =
  (): InventoryTransactionDetail[] => {
    return inventoryTransactionDetails.filter(
      (detail) => detail.dimension !== null
    );
  };

// READ - อ่าน InventoryTransactionDetail ตาม qty range
export const getInventoryTransactionDetailsByQtyRange = (
  minQty: number,
  maxQty: number
): InventoryTransactionDetail[] => {
...
export const getInventoryTransactionDetailsByCostRange = (
  minCost: number,
  maxCost: number
): InventoryTransactionDetail[] => {
  return inventoryTransactionDetails.filter((detail) => {
...
export const getInventoryTransactionDetailsByTotalCostRange = (
  minTotalCost: number,
  maxTotalCost: number
): InventoryTransactionDetail[] => {
  return inventoryTransactionDetails.filter((detail) => {
...
export const searchInventoryTransactionDetailsFuzzy = (
  searchTerm: string
): InventoryTransactionDetail[] => {
...
export const updateInventoryTransactionDetail = (
  id: string,
  updateData: Partial<
    Omit<InventoryTransactionDetail, "id" | "created_at" | "created_by_id">
  >
): InventoryTransactionDetail | null => {
  const index = inventoryTransactionDetails.findIndex(
    (detail) => detail.id === id
  );
...
export const updateInventoryTransactionDetailFromLotNo = (
  id: string,
  fromLotNo: string
): InventoryTransactionDetail | null => {
...
export const updateInventoryTransactionDetailCurrentLotNo = (
  id: string,
  currentLotNo: string
): InventoryTransactionDetail | null => {
...
export const updateInventoryTransactionDetailQty = (
  id: string,
  qty: string
): InventoryTransactionDetail | null => {
...
export const updateInventoryTransactionDetailCostPerUnit = (
  id: string,
  costPerUnit: string
): InventoryTransactionDetail | null => {
...
export const updateInventoryTransactionDetailTotalCost = (
  id: string,
  totalCost: string
): InventoryTransactionDetail | null => {
...
export const updateInventoryTransactionDetailNote = (
  id: string,
  note: string
): InventoryTransactionDetail | null => {
...
export const updateInventoryTransactionDetailInfo = (
  id: string,
  info: any
): InventoryTransactionDetail | null => {
...
export const updateInventoryTransactionDetailDimension = (
  id: string,
  dimension: any
): InventoryTransactionDetail | null => {
...
export const updateInventoryTransactionDetailByTransactionAndFromLot = (
  transactionId: string,
  fromLotNo: string,
  updateData: Partial<
    Omit<InventoryTransactionDetail, "id" | "created_at" | "created_by_id">
  ...
  const index = inventoryTransactionDetails.findIndex(
    (detail) =>
      detail.inventory_transaction_id === transactionId &&
      detail.from_lot_no === fromLotNo
  );
...
export const deleteInventoryTransactionDetail = (
  id: string,
  deletedById: string
): boolean => {
  const index = inventoryTransactionDetails.findIndex(
...
export const deleteInventoryTransactionDetailsByTransactionId = (
  transactionId: string,
  deletedById: string
): number => {
  let deletedCount = 0;
...
export const deleteInventoryTransactionDetailsByFromLotNo = (
  fromLotNo: string,
  deletedById: string
): number => {
  let deletedCount = 0;
...
export const deleteInventoryTransactionDetailsByCurrentLotNo = (
  currentLotNo: string,
  deletedById: string
): number => {
  let deletedCount = 0;
...
export const deleteInventoryTransactionDetailsByLocationId = (
  locationId: string,
  deletedById: string
): number => {
  let deletedCount = 0;
...
export const deleteInventoryTransactionDetailsByProductId = (
  productId: string,
  deletedById: string
): number => {
  let deletedCount = 0;
...
export const deleteInventoryTransactionDetailByTransactionAndFromLot = (
  transactionId: string,
  fromLotNo: string,
  deletedById: string
): boolean => {
...
export const restoreInventoryTransactionDetailsByTransactionId = (
  transactionId: string
): number => {
  let restoredCount = 0;
...
export const restoreInventoryTransactionDetailsByFromLotNo = (
  fromLotNo: string
): number => {
  let restoredCount = 0;
...
export const restoreInventoryTransactionDetailsByCurrentLotNo = (
  currentLotNo: string
): number => {
  let restoredCount = 0;
...
export const restoreInventoryTransactionDetailsByLocationId = (
  locationId: string
): number => {
  let restoredCount = 0;
...
export const restoreInventoryTransactionDetailsByProductId = (
  productId: string
): number => {
  let restoredCount = 0;
...
export const getInventoryTransactionDetailCountByTransactionId = (
  transactionId: string
): number => {
  return inventoryTransactionDetails.filter(
    (detail) => detail.inventory_transaction_id === transactionId
...
export const getInventoryTransactionDetailCountByFromLotNo = (
  fromLotNo: string
): number => {
  return inventoryTransactionDetails.filter(
    (detail) => detail.from_lot_no === fromLotNo
...
export const getInventoryTransactionDetailCountByCurrentLotNo = (
  currentLotNo: string
): number => {
  return inventoryTransactionDetails.filter(
    (detail) => detail.current_lot_no === currentLotNo
...
export const getInventoryTransactionDetailCountByLocationId = (
  locationId: string
): number => {
  return inventoryTransactionDetails.filter(
    (detail) => detail.location_id === locationId
...
export const getInventoryTransactionDetailCountByProductId = (
  productId: string
): number => {
  return inventoryTransactionDetails.filter(
    (detail) => detail.product_id === productId
...
export const getInventoryTransactionDetailCountByCreatedBy = (
  createdById: string
): number => {
  return inventoryTransactionDetails.filter(
    (detail) => detail.created_by_id === createdById
...
export const getInventoryTransactionDetailCountByUpdatedBy = (
  updatedById: string
): number => {
  return inventoryTransactionDetails.filter(
    (detail) => detail.updated_by_id === updatedById
...
export const searchInventoryTransactionDetails = (searchCriteria: {
  ...
  return inventoryTransactionDetails.filter((detail) => {
    ...
    if (
      searchCriteria.from_lot_no &&
      detail.from_lot_no !== searchCriteria.from_lot_no
    ) {
      return false;
    }

    if (
      searchCriteria.current_lot_no &&
      detail.current_lot_no !== searchCriteria.current_lot_no
    ) {
      return false;
    }
...
export const isInventoryTransactionDetailExistsByTransactionId = (
  transactionId: string
): boolean => {
  return inventoryTransactionDetails.some(
    (detail) => detail.inventory_transaction_id === transactionId
  );
};

// Utility function สำหรับตรวจสอบ InventoryTransactionDetail ตาม from_lot_no
export const isInventoryTransactionDetailExistsByFromLotNo = (
  fromLotNo: string
): boolean => {
  return inventoryTransactionDetails.some(
    (detail) => detail.from_lot_no === fromLotNo
...
export const isInventoryTransactionDetailExistsByCurrentLotNo = (
  currentLotNo: string
): boolean => {
  return inventoryTransactionDetails.some(
    (detail) => detail.current_lot_no === currentLotNo
...
export const isInventoryTransactionDetailExistsByTransactionAndFromLot = (
  transactionId: string,
  fromLotNo: string
): boolean => {
  return inventoryTransactionDetails.some(
...
export const addMultipleInventoryTransactionDetails = (
  transactionDetailsData: Omit<
    InventoryTransactionDetail,
    "id" | "created_at" | "updated_at"
  >[]
): InventoryTransactionDetail[] => {
...
export const removeMultipleInventoryTransactionDetailsByTransactionId = (
  transactionId: string,
  deletedById: string
): number => {
  return deleteInventoryTransactionDetailsByTransactionId(
    transactionId,
    deletedById
  );
};
...
export const removeMultipleInventoryTransactionDetailsByFromLotNo = (
  fromLotNo: string,
  deletedById: string
): number => {
...
export const removeMultipleInventoryTransactionDetailsByCurrentLotNo = (
  currentLotNo: string,
  deletedById: string
): number => {
  return deleteInventoryTransactionDetailsByCurrentLotNo(
    currentLotNo,
    deletedById
  );
};
...
export const removeMultipleInventoryTransactionDetailsByLocationId = (
  locationId: string,
  deletedById: string
): number => {
...
export const removeMultipleInventoryTransactionDetailsByProductId = (
  productId: string,
  deletedById: string
): number => {
...
export const hardDeleteInventoryTransactionDetailsByTransactionId = (
  transactionId: string
): number => {
  let deletedCount = 0;
  ...
  for (let i = inventoryTransactionDetails.length - 1; i >= 0; i--) {
    if (
      inventoryTransactionDetails[i].inventory_transaction_id === transactionId
    ) {
...
export const hardDeleteInventoryTransactionDetailsByFromLotNo = (
  fromLotNo: string
): number => {
  let deletedCount = 0;
...
export const hardDeleteInventoryTransactionDetailsByCurrentLotNo = (
  currentLotNo: string
): number => {
  let deletedCount = 0;
...
export const hardDeleteInventoryTransactionDetailsByLocationId = (
  locationId: string
): number => {
  let deletedCount = 0;
...
export const hardDeleteInventoryTransactionDetailsByProductId = (
  productId: string
): number => {
  let deletedCount = 0;
