...
export const createPurchaseRequestTemplateDetail = (data: Omit<PurchaseRequestTemplateDetail, 'id' | 'created_at' | 'created_by_id'>): PurchaseRequestTemplateDetail => {
...
export const getAllPurchaseRequestTemplateDetails = (): PurchaseRequestTemplateDetail[] => {
  return purchaseRequestTemplateDetails.filter(detail => !detail.deleted_at);
};

// READ - อ่าน PurchaseRequestTemplateDetail ตาม ID
export const getPurchaseRequestTemplateDetailById = (id: string): PurchaseRequestTemplateDetail | null => {
  const detail = purchaseRequestTemplateDetails.find(detail => detail.id === id && !detail.deleted_at);
  return detail || null;
};

// READ - อ่าน PurchaseRequestTemplateDetail ตาม purchase_request_template_id
export const getPurchaseRequestTemplateDetailsByTemplateId = (templateId: string): PurchaseRequestTemplateDetail[] => {
  return purchaseRequestTemplateDetails.filter(detail => detail.purchase_request_template_id === templateId && !detail.deleted_at);
};

// READ - อ่าน PurchaseRequestTemplateDetail ตาม location_id
export const getPurchaseRequestTemplateDetailsByLocationId = (locationId: string): PurchaseRequestTemplateDetail[] => {
  return purchaseRequestTemplateDetails.filter(detail => detail.location_id === locationId && !detail.deleted_at);
};

// READ - อ่าน PurchaseRequestTemplateDetail ตาม product_id
export const getPurchaseRequestTemplateDetailsByProductId = (productId: string): PurchaseRequestTemplateDetail[] => {
  return purchaseRequestTemplateDetails.filter(detail => detail.product_id === productId && !detail.deleted_at);
};

// READ - อ่าน PurchaseRequestTemplateDetail ตาม currency_id
export const getPurchaseRequestTemplateDetailsByCurrencyId = (currencyId: string): PurchaseRequestTemplateDetail[] => {
  return purchaseRequestTemplateDetails.filter(detail => detail.currency_id === currencyId && !detail.deleted_at);
};

// READ - อ่าน PurchaseRequestTemplateDetail ที่ active
export const getActivePurchaseRequestTemplateDetails = (): PurchaseRequestTemplateDetail[] => {
  return purchaseRequestTemplateDetails.filter(detail => detail.is_active && !detail.deleted_at);
};

// READ - อ่าน PurchaseRequestTemplateDetail ที่ inactive
export const getInactivePurchaseRequestTemplateDetails = (): PurchaseRequestTemplateDetail[] => {
  return purchaseRequestTemplateDetails.filter(detail => !detail.is_active && !detail.deleted_at);
};

// READ - อ่าน PurchaseRequestTemplateDetail ที่มี description
export const getPurchaseRequestTemplateDetailsWithDescription = (): PurchaseRequestTemplateDetail[] => {
  return purchaseRequestTemplateDetails.filter(detail => detail.description && detail.description.trim() !== '' && !detail.deleted_at);
};

// READ - อ่าน PurchaseRequestTemplateDetail ที่มี comment
export const getPurchaseRequestTemplateDetailsWithComment = (): PurchaseRequestTemplateDetail[] => {
  return purchaseRequestTemplateDetails.filter(detail => detail.comment && detail.comment.trim() !== '' && !detail.deleted_at);
};

// READ - อ่าน PurchaseRequestTemplateDetail ที่มี foc_qty
export const getPurchaseRequestTemplateDetailsWithFocQty = (): PurchaseRequestTemplateDetail[] => {
  return purchaseRequestTemplateDetails.filter(detail => detail.foc_qty && !detail.deleted_at);
};

// READ - อ่าน PurchaseRequestTemplateDetail ที่มี tax_amount
export const getPurchaseRequestTemplateDetailsWithTaxAmount = (): PurchaseRequestTemplateDetail[] => {
  return purchaseRequestTemplateDetails.filter(detail => detail.tax_amount && !detail.deleted_at);
};

// READ - อ่าน PurchaseRequestTemplateDetail ที่มี discount_amount
export const getPurchaseRequestTemplateDetailsWithDiscountAmount = (): PurchaseRequestTemplateDetail[] => {
  return purchaseRequestTemplateDetails.filter(detail => detail.discount_amount && !detail.deleted_at);
};

// READ - อ่าน PurchaseRequestTemplateDetail ที่มี info
export const getPurchaseRequestTemplateDetailsWithInfo = (): PurchaseRequestTemplateDetail[] => {
  return purchaseRequestTemplateDetails.filter(detail => detail.info && !detail.deleted_at);
};

// READ - อ่าน PurchaseRequestTemplateDetail ที่มี dimension
export const getPurchaseRequestTemplateDetailsWithDimension = (): PurchaseRequestTemplateDetail[] => {
  return purchaseRequestTemplateDetails.filter(detail => detail.dimension && !detail.deleted_at);
};

// READ - ค้นหา PurchaseRequestTemplateDetail แบบ fuzzy search
export const searchPurchaseRequestTemplateDetails = (searchTerm: string): PurchaseRequestTemplateDetail[] => {
  const lowerSearchTerm = searchTerm.toLowerCase();
  
  return purchaseRequestTemplateDetails.filter(detail => 
    !detail.deleted_at && (
...
export const updatePurchaseRequestTemplateDetail = (id: string, updates: Partial<Omit<PurchaseRequestTemplateDetail, 'id' | 'created_at' | 'created_by_id'>>): PurchaseRequestTemplateDetail | null => {
  const index = purchaseRequestTemplateDetails.findIndex(detail => detail.id === id);
...
export const updatePurchaseRequestTemplateDetailDescription = (id: string, description: string): PurchaseRequestTemplateDetail | null => {
  return updatePurchaseRequestTemplateDetail(id, { description });
};

// UPDATE - อัปเดต PurchaseRequestTemplateDetail comment
export const updatePurchaseRequestTemplateDetailComment = (id: string, comment: string): PurchaseRequestTemplateDetail | null => {
  return updatePurchaseRequestTemplateDetail(id, { comment });
};

// UPDATE - อัปเดต PurchaseRequestTemplateDetail requested_qty
export const updatePurchaseRequestTemplateDetailRequestedQty = (id: string, requestedQty: string): PurchaseRequestTemplateDetail | null => {
  return updatePurchaseRequestTemplateDetail(id, { requested_qty: requestedQty });
};

// UPDATE - อัปเดต PurchaseRequestTemplateDetail foc_qty
export const updatePurchaseRequestTemplateDetailFocQty = (id: string, focQty: string): PurchaseRequestTemplateDetail | null => {
  return updatePurchaseRequestTemplateDetail(id, { foc_qty: focQty });
};

// UPDATE - อัปเดต PurchaseRequestTemplateDetail tax_amount
export const updatePurchaseRequestTemplateDetailTaxAmount = (id: string, taxAmount: string): PurchaseRequestTemplateDetail | null => {
...
export const updatePurchaseRequestTemplateDetailDiscountAmount = (id: string, discountAmount: string): PurchaseRequestTemplateDetail | null => {
  return updatePurchaseRequestTemplateDetail(id, { discount_amount: discountAmount });
};

// UPDATE - อัปเดต PurchaseRequestTemplateDetail active status
export const updatePurchaseRequestTemplateDetailActiveStatus = (id: string, isActive: boolean): PurchaseRequestTemplateDetail | null => {
  return updatePurchaseRequestTemplateDetail(id, { is_active: isActive });
};

// UPDATE - อัปเดต PurchaseRequestTemplateDetail info
export const updatePurchaseRequestTemplateDetailInfo = (id: string, info: any): PurchaseRequestTemplateDetail | null => {
  return updatePurchaseRequestTemplateDetail(id, { info });
};

// UPDATE - อัปเดต PurchaseRequestTemplateDetail dimension
export const updatePurchaseRequestTemplateDetailDimension = (id: string, dimension: any): PurchaseRequestTemplateDetail | null => {
  return updatePurchaseRequestTemplateDetail(id, { dimension });
};

// UPDATE - อัปเดต PurchaseRequestTemplateDetail doc_version
export const updatePurchaseRequestTemplateDetailDocVersion = (id: string, docVersion: string): PurchaseRequestTemplateDetail | null => {
  return updatePurchaseRequestTemplateDetail(id, { doc_version: docVersion });
};

// DELETE - ลบ PurchaseRequestTemplateDetail (soft delete)
export const deletePurchaseRequestTemplateDetail = (id: string, deletedById: string): boolean => {
  const index = purchaseRequestTemplateDetails.findIndex(detail => detail.id === id);
...
export const hardDeletePurchaseRequestTemplateDetail = (id: string): boolean => {
  const index = purchaseRequestTemplateDetails.findIndex(detail => detail.id === id);
...
export const deletePurchaseRequestTemplateDetailsByTemplateId = (templateId: string, deletedById: string): number => {
  let deletedCount = 0;
  
  purchaseRequestTemplateDetails.forEach(detail => {
    if (detail.purchase_request_template_id === templateId && !detail.deleted_at) {
...
export const deletePurchaseRequestTemplateDetailsByLocationId = (locationId: string, deletedById: string): number => {
  let deletedCount = 0;
...
export const deletePurchaseRequestTemplateDetailsByProductId = (productId: string, deletedById: string): number => {
  let deletedCount = 0;
...
export const restorePurchaseRequestTemplateDetailsByTemplateId = (templateId: string): number => {
  let restoredCount = 0;
...
export const restorePurchaseRequestTemplateDetailsByLocationId = (locationId: string): number => {
  let restoredCount = 0;
...
export const restorePurchaseRequestTemplateDetailsByProductId = (productId: string): number => {
  let restoredCount = 0;
...
export const getPurchaseRequestTemplateDetailCountByTemplateId = (templateId: string): number => {
  return purchaseRequestTemplateDetails.filter(detail => detail.purchase_request_template_id === templateId).length;
};

// Utility function สำหรับนับจำนวน PurchaseRequestTemplateDetail ตาม location_id
export const getPurchaseRequestTemplateDetailCountByLocationId = (locationId: string): number => {
  return purchaseRequestTemplateDetails.filter(detail => detail.location_id === locationId).length;
};

// Utility function สำหรับนับจำนวน PurchaseRequestTemplateDetail ตาม product_id
export const getPurchaseRequestTemplateDetailCountByProductId = (productId: string): number => {
  return purchaseRequestTemplateDetails.filter(detail => detail.product_id === productId).length;
};
...
export const getActivePurchaseRequestTemplateDetailCount = (): number => {
  return purchaseRequestTemplateDetails.filter(detail => detail.is_active).length;
};
...
export const getDeletedPurchaseRequestTemplateDetails = (): PurchaseRequestTemplateDetail[] => {
  return purchaseRequestTemplateDetails.filter(detail => detail.deleted_at !== null);
};

// Utility function สำหรับตรวจสอบ PurchaseRequestTemplateDetail ที่มี description
export const hasPurchaseRequestTemplateDetailDescription = (id: string): boolean => {
  const detail = getPurchaseRequestTemplateDetailById(id);
  return detail ? !!(detail.description && (detail.description as string).trim() !== '') : false;
};

// Utility function สำหรับตรวจสอบ PurchaseRequestTemplateDetail ที่มี comment
export const hasPurchaseRequestTemplateDetailComment = (id: string): boolean => {
  const detail = getPurchaseRequestTemplateDetailById(id);
  return detail ? !!(detail.comment && (detail.comment as string).trim() !== '') : false;
};
...
export const hasPurchaseRequestTemplateDetailFocQty = (id: string): boolean => {
  const detail = getPurchaseRequestTemplateDetailById(id);
  return detail ? !!(detail.foc_qty && (detail.foc_qty as string).trim() !== '') : false;
};

// Utility function สำหรับตรวจสอบ PurchaseRequestTemplateDetail ที่มี tax_amount
export const hasPurchaseRequestTemplateDetailTaxAmount = (id: string): boolean => {
  const detail = getPurchaseRequestTemplateDetailById(id);
  return detail ? !!(detail.tax_amount && (detail.tax_amount as string).trim() !== '') : false;
};

// Utility function สำหรับตรวจสอบ PurchaseRequestTemplateDetail ที่มี discount_amount
export const hasPurchaseRequestTemplateDetailDiscountAmount = (id: string): boolean => {
  const detail = getPurchaseRequestTemplateDetailById(id);
  return detail ? !!(detail.discount_amount && (detail.discount_amount as string).trim() !== '') : false;
};
...
export const hasPurchaseRequestTemplateDetailDimension = (id: string): boolean => {
  const detail = getPurchaseRequestTemplateDetailById(id);
...
export const hasPurchaseRequestTemplateDetailCreatedBy = (id: string): boolean => {
  const detail = getPurchaseRequestTemplateDetailById(id);
  return detail ? !!(detail.created_by_id && (detail.created_by_id as string).trim() !== '') : false;
};

// Utility function สำหรับตรวจสอบ PurchaseRequestTemplateDetail ที่มี updated_by_id
export const hasPurchaseRequestTemplateDetailUpdatedBy = (id: string): boolean => {
  const detail = getPurchaseRequestTemplateDetailById(id);
  return detail ? !!(detail.updated_by_id && (detail.updated_by_id as string).trim() !== '') : false;
};

// Utility function สำหรับตรวจสอบ PurchaseRequestTemplateDetail ที่มี deleted_by_id
export const hasPurchaseRequestTemplateDetailDeletedBy = (id: string): boolean => {
  const detail = getPurchaseRequestTemplateDetailById(id);
  return detail ? !!(detail.deleted_by_id && (detail.deleted_by_id as string).trim() !== '') : false;
};

// Utility function สำหรับตรวจสอบ PurchaseRequestTemplateDetail ที่มี created_at
export const hasPurchaseRequestTemplateDetailCreatedAt = (id: string): boolean => {
  const detail = getPurchaseRequestTemplateDetailById(id);
  return detail ? !!(detail.created_at && (detail.created_at as string).trim() !== '') : false;
};

// Utility function สำหรับตรวจสอบ PurchaseRequestTemplateDetail ที่มี updated_at
export const hasPurchaseRequestTemplateDetailUpdatedAt = (id: string): boolean => {
  const detail = getPurchaseRequestTemplateDetailById(id);
  return detail ? !!(detail.updated_at && (detail.updated_at as string).trim() !== '') : false;
};

// Utility function สำหรับตรวจสอบ PurchaseRequestTemplateDetail ที่มี deleted_at
export const hasPurchaseRequestTemplateDetailDeletedAt = (id: string): boolean => {
  const detail = getPurchaseRequestTemplateDetailById(id);
  return detail ? !!(detail.deleted_at && (detail.deleted_at as string).trim() !== '') : false;
};
