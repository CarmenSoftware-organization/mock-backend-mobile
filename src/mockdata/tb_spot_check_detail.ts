...
export const spotChecksDetails: SpotCheckDetail[] = [
  ...
  // SPOT_CHECK_02 details
  {
    ...
    product_local_name: product11?.local_name || "",
    inventory_unit_id: product11?.inventory_unit_id || "",
    inventory_unit_name: product11?.inventory_unit_name || "",
    sku: product11?.sku || "",
    on_hand_qty: 450,
    actual_qty: 445,
    submitted_qty: 445,
  ...
  },
  {
    ...
    product_local_name: product12?.local_name || "",
    inventory_unit_id: product12?.inventory_unit_id || "",
    inventory_unit_name: product12?.inventory_unit_name || "",
    sku: product12?.sku || "",
    on_hand_qty: 280,
    actual_qty: 285,
    submitted_qty: 285,
  ...
  },
  {
    ...
    product_local_name: product13?.local_name || "",
    inventory_unit_id: product13?.inventory_unit_id || "",
    inventory_unit_name: product13?.inventory_unit_name || "",
    sku: product13?.sku || "",
    on_hand_qty: 150,
    actual_qty: 150,
    submitted_qty: 150,
  ...
  // SPOT_CHECK_03 details (completed)
  {
    ...
    product_local_name: product14?.local_name || "",
    inventory_unit_id: product14?.inventory_unit_id || "",
    inventory_unit_name: product14?.inventory_unit_name || "",
    sku: product14?.sku || "",
    on_hand_qty: 75,
    actual_qty: 72,
    submitted_qty: 72,
  ...
  },
  {
    ...
    product_local_name: product15?.local_name || "",
    inventory_unit_id: product15?.inventory_unit_id || "",
    inventory_unit_name: product15?.inventory_unit_name || "",
    sku: product15?.sku || "",
    on_hand_qty: 120,
    actual_qty: 118,
    submitted_qty: 118,
  ...
  // SPOT_CHECK_10 details (pharmaceuticals completed)
  {
    ...
    product_local_name: product16?.local_name || "",
    inventory_unit_id: product16?.inventory_unit_id || "",
    inventory_unit_name: product16?.inventory_unit_name || "",
    sku: product16?.sku || "",
    on_hand_qty: 500,
    actual_qty: 498,
    submitted_qty: 498,
  ...
  },
  {
    ...
    product_local_name: product17?.local_name || "",
    inventory_unit_id: product17?.inventory_unit_id || "",
    inventory_unit_name: product17?.inventory_unit_name || "",
    sku: product17?.sku || "",
    on_hand_qty: 350,
    actual_qty: 345,
    submitted_qty: 345,
  ...
  },
  {
    ...
    product_local_name: product18?.local_name || "",
    inventory_unit_id: product18?.inventory_unit_id || "",
    inventory_unit_name: product18?.inventory_unit_name || "",
    sku: product18?.sku || "",
    on_hand_qty: 200,
    actual_qty: 200,
    submitted_qty: 200,
  ...
  // SPOT_CHECK_14 details (food storage completed)
  {
    ...
    product_local_name: product19?.local_name || "",
    inventory_unit_id: product19?.inventory_unit_id || "",
    inventory_unit_name: product19?.inventory_unit_name || "",
    sku: product19?.sku || "",
    on_hand_qty: 300,
    actual_qty: 295,
    submitted_qty: 295,
  ...
  },
  {
    ...
    product_local_name: product20?.local_name || "",
    inventory_unit_id: product20?.inventory_unit_id || "",
    inventory_unit_name: product20?.inventory_unit_name || "",
    sku: product20?.sku || "",
    on_hand_qty: 150,
    actual_qty: 148,
    submitted_qty: 148,
...
export const getSpotcheckById = (id: string) => {
  ...
  const details = spotChecksDetails.filter(spotcheck => spotcheck.spot_check_id === id).map(spotcheck => ({
    ...
    product_local_name: spotcheck.product_local_name,
    inventory_unit_id: spotcheck.inventory_unit_id,
    inventory_unit_name: spotcheck.inventory_unit_name,
    sku: spotcheck.sku,
