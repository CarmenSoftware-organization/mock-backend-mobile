...
export const createStockTakeDetail = (
  data: Omit<
    StockTakeDetail,
...
export const getStockTakeDetailsByStockTakeId = (
  stockTakeId: string
): StockTakeDetail[] => {
  return stockTakeDetails.filter(
    (d) => d.stock_take_id === stockTakeId && !d.deleted_at
  );
};

export const getStockTakeDetailsByInventoryTransactionId = (
...
export const getStockTakeDetailsByProductId = (
  productId: string
): StockTakeDetail[] => {
  return stockTakeDetails.filter(
...
export const getStockTakeDetailsByLocationId = (
  locationId: string
): StockTakeDetail[] => {
  return stockTakeDetails.filter(
...
export const getStockTakeDetailsBySequenceNo = (
  stockTakeId: string,
  sequenceNo: number
): StockTakeDetail | null => {
  const detail = stockTakeDetails.find(
    (d) =>
...
export const updateStockTakeDetail = (
  id: string,
  data: Partial<Omit<StockTakeDetail, "id" | "created_at" | "created_by_id">>
): StockTakeDetail | null => {
...
export const updateStockTakeDetailDescription = (
  id: string,
  description: string
): StockTakeDetail | null => {
...
export const updateStockTakeDetailQty = (
  id: string,
  qty: string
): StockTakeDetail | null => {
...
export const updateStockTakeDetailNote = (
  id: string,
  note: string
): StockTakeDetail | null => {
...
export const updateStockTakeDetailInfo = (
  id: string,
  info: any
): StockTakeDetail | null => {
...
export const updateStockTakeDetailDimension = (
  id: string,
  dimension: any
): StockTakeDetail | null => {
...
export const updateStockTakeDetailLocation = (
  id: string,
  locationId: string,
  locationName: string
): StockTakeDetail | null => {
...
export const updateStockTakeDetailProduct = (
  id: string,
  productId: string,
  productName: string,
...
export const softDeleteStockTakeDetail = (
  id: string,
  deletedById: string
): StockTakeDetail | null => {
...
export const deleteStockTakeDetailsByStockTakeId = (
  stockTakeId: string,
  deletedById: string
): number => {
  let deletedCount = 0;
...
export const searchStockTakeDetails = (criteria: {
  ...
  return stockTakeDetails.filter((detail) => {
    ...
    if (criteria.stockTakeId && detail.stock_take_id !== criteria.stockTakeId)
      return false;
    if (
...
export const getStockTakeDetailCountByStockTakeId = (
  stockTakeId: string
): number => {
  return stockTakeDetails.filter(
    (detail) => detail.stock_take_id === stockTakeId && !detail.deleted_at
  ).length;
};

export const isStockTakeDetailExists = (id: string): boolean => {
  return stockTakeDetails.some(
...
export const clearStockTakeDetailsByStockTakeId = (
  stockTakeId: string
): void => {
