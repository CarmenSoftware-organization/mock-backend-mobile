...
export const createCreditTerm = (
  creditTermData: Omit<CreditTerm, "id" | "created_at" | "updated_at">
): CreditTerm => {
...
export const getCreditTermsByDocVersion = (
  docVersion: string
): CreditTerm[] => {
  return creditTerms.filter(
    (creditTerm) => creditTerm.doc_version === docVersion
  );
};

// UPDATE - อัปเดต CreditTerm
export const updateCreditTerm = (
  id: string,
  updateData: Partial<Omit<CreditTerm, "id" | "created_at" | "created_by_id">>
): CreditTerm | null => {
...
export const updateCreditTermStatus = (
  id: string,
  isActive: boolean
): CreditTerm | null => {
...
export const updateCreditTermName = (
  id: string,
  name: string
): CreditTerm | null => {
...
export const updateCreditTermValue = (
  id: string,
  value: number
): CreditTerm | null => {
...
export const updateCreditTermDescription = (
  id: string,
  description: string
): CreditTerm | null => {
...
export const updateCreditTermNote = (
  id: string,
  note: string
): CreditTerm | null => {
...
export const updateCreditTermDocVersion = (
  id: string,
  docVersion: string
): CreditTerm | null => {
...
export const deleteCreditTermByName = (
  name: string,
  deletedById: string
): boolean => {
...
export const deleteCreditTermByValue = (
  value: number,
  deletedById: string
): boolean => {
...
export const searchCreditTerms = (searchCriteria: {
  ...
  return creditTerms.filter((creditTerm) => {
    if (
      searchCriteria.name &&
      !creditTerm.name.toLowerCase().includes(searchCriteria.name.toLowerCase())
    ) {
      return false;
    }
    ...
    if (
      ...
      creditTerm.is_active !== searchCriteria.is_active
    ) {
      return false;
    }
    ...
    if (
      ...
      creditTerm.doc_version !== searchCriteria.doc_version
    ) {
      return false;
    }
