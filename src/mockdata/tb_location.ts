...
export const updateLocation = (id: string, updateData: Partial<Omit<Location, 'id' | 'created_at' | 'created_by_id'>>): Location | null => {
...
export const updateLocationDeliveryPoint = (id: string, deliveryPointId: string, deliveryPointName: string): Location | null => {
