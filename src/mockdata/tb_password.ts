...
export const createPassword = (
  passwordData: Omit<Password, "id" | "created_at">
): Password => {
...
export const getExpiredPasswords = (): Password[] => {
  ...
  return passwords.filter(
    (password) => password.expired_on && new Date(password.expired_on) < now
  );
};
...
export const updatePassword = (
  id: string,
  updateData: Partial<Omit<Password, "id" | "created_at" | "created_by_id">>
): Password | null => {
...
export const updatePasswordActiveStatus = (
  id: string,
  isActive: boolean
): Password | null => {
...
export const updatePasswordExpiryDate = (
  id: string,
...
export const searchPasswords = (searchCriteria: {
  ...
  return passwords.filter((password) => {
    ...
    if (
      ...
      password.is_active !== searchCriteria.is_active
    ) {
      return false;
    }
